...
class NDayViewWidget extends StatefulWidget {
  final double? width;
  final int numberOfDays;

  const NDayViewWidget({
    super.key,
    this.width,
  ...
  @override
  State<NDayViewWidget> createState() => _NDayViewWidgetState();
}

class _NDayViewWidgetState extends State<NDayViewWidget> {
    ...
    return Listener(
        ...
        onPointerMove: (details) {
          ...
          if (_pointerPositions.length == 2) {
            ...
            setState(() {
              heightPerMinute = (initialHeightPerMinute + deltaPerMinute).clamp(0.5, 5.0);
            });
          }
        },
        child: NDayView(
